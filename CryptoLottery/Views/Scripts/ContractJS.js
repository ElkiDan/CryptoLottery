...
var conAbi = JSON.parse(
    '[ { "constant": false, "inputs": [ { "name": "_stringRandomNumber", "type": "string" } ], "name": "submitRandomness", "outputs": [ { "name": "", "type": "bool" } ], "payable": false, "stateMutability": "nonpayable", "type": "function" }, { "constant": true, "inputs": [ { "name": "", "type": "uint256" } ], "name": "honestPlayersAddresses", "outputs": [ { "name": "", "type": "address" } ], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": false, "inputs": [ { "name": "_hashedRandom", "type": "bytes32" }, { "name": "amountOfWeiSent", "type": "uint256" } ], "name": "addNewPlayer", "outputs": [], "payable": false, "stateMutability": "nonpayable", "type": "function" }, { "constant": true, "inputs": [], "name": "getContractBalance", "outputs": [ { "name": "", "type": "uint256" } ], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": false, "inputs": [], "name": "checkIfLotteryCanStart", "outputs": [ { "name": "", "type": "bool" } ], "payable": false, "stateMutability": "nonpayable", "type": "function" }, { "constant": true, "inputs": [ { "name": "", "type": "uint256" } ], "name": "randomNumbersGathered", "outputs": [ { "name": "", "type": "int256" } ], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": true, "inputs": [ { "name": "", "type": "address" } ], "name": "players", "outputs": [ { "name": "playersAddress", "type": "address" }, { "name": "hashedRandom", "type": "bytes32" }, { "name": "amountOfEtherSent", "type": "uint256" }, { "name": "sentRandom", "type": "bool" } ], "payable": false, "stateMutability": "view", "type": "function" }, { "inputs": [], "payable": false, "stateMutability": "nonpayable", "type": "constructor" }, { "payable": true, "stateMutability": "payable", "type": "fallback" }, { "anonymous": false, "inputs": [], "name": "AnnonceSentRandom", "type": "event" }, { "anonymous": false, "inputs": [ { "indexed": false, "name": "winner", "type": "address" }, { "indexed": false, "name": "lotteryInitiator", "type": "address" } ], "name": "AnnounceWinner", "type": "event" } ]'
);  
var myContract = web3.eth.contract(conAbi);
var contractAddress = "0x76c99d366fe790d969dfbd9d4cd58ccffecff6a1";
